...
(function () {
  ...
  var ICON = {
    ...
    vk: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M15.07 2H8.93C3.33 2 2 3.33 2 8.93v6.14C2 20.67 3.33 22 8.93 22h6.14C20.67 22 22 20.67 22 15.07V8.93C22 3.33 20.68 2 15.07 2zm3.15 14.27h-1.46c-.55 0-.72-.44-1.71-1.44-.86-.83-1.25-.94-1.46-.94-.3 0-.38.08-.38.49v1.31c0 .35-.11.56-1.03.56-1.53 0-3.22-.93-4.42-2.65-1.8-2.54-2.29-4.45-2.29-4.84 0-.21.08-.4.49-.4h1.46c.37 0 .51.17.65.56.72 2.09 1.92 3.92 2.42 3.92.19 0 .27-.08.27-.57V11.1c-.06-1.06-.62-1.15-.62-1.53 0-.18.15-.35.39-.35h2.29c.31 0 .42.16.42.53v3.08c0 .31.13.42.22.42.19 0 .34-.11.69-.46 1.06-1.19 1.82-3.04 1.82-3.04.1-.22.28-.42.65-.42h1.46c.44 0 .53.22.44.53-.18.85-1.97 3.38-1.97 3.38-.15.25-.21.36 0 .64.15.21.64.63.97 1.02.61.69 1.07 1.27 1.2 1.67.12.4-.08.6-.49.6z"/></svg>',
